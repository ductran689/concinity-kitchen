...
export default function Gallery() {
  return (
    <div className="gallery mt-4 ">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-2 justify-items-center">
        {data.gallery.map((gallery, i) => (
          <div
            className="gallery_element w-[90%]  bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative"
            key={Math.random()}
          >
